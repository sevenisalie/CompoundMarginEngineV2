...
export class Listenator {
    ...
    private executor: (txHash: string) => void; //executor function should return true on succ and false on fail
    constructor(_contract: Contract, _eventTopic: string, _executorFunction: (txHash: string) => void) {
